...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002162009915"))
# NAMA OWNER
OWNER = os.environ.get("OWNER", "VeldXd")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1701345142"))
#Port
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002245115839"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002147075554"))
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "1701345142").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @PCSOFTKEYS </b>")
